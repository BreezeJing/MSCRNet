...
def main():
    ...
    parser.add_argument('--datapath', type=str, default=r"F:\SceneFlow/")
    parser.add_argument('--epochs', type=int, default=1000)
    parser.add_argument('--loadmodel', type=str, default=r'F:\mobelnetV11\250312SC\best_loss.tar')
    parser.add_argument('--savemodel', type=str, default='./250312SC/')
    parser.add_argument('--gpu_ids', type=str, default='1', help='逗号分隔的显卡ID，如：0 或 0,1,2')
